...
const OrderStatus = ({ status }) => {
  ...
  return (
    <span
      className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${styles[status] || "bg-[#F5F5F5] text-[#737373]"}`}
    >
      {status}
    </span>
  );
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex flex-col gap-6 sm:gap-8 px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex flex-col gap-1">
          <h4 className="text-2xl font-bold text-[#000000]!">
            Order Oversight
          </h4>
          <p className="text-xs sm:text-sm text-[#8C8C8C]">
            View active deliveries, placement history, and courier tracking
            details
          </p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-[#F9F9F9] border-b border-[#EDEDED]">
                <th className="px-4 py-3 text-xs font-semibold text-[#000000]">
                  Order ID
                </th>
                <th className="px-4 py-3 text-xs font-semibold text-[#000000]">
                  Customer
                ...
                <th className="px-4 py-3 text-xs font-semibold text-[#000000]">
                  Placed Date / Delivered Date &amp; Time
                </th>
                <th className="px-4 py-3 text-xs font-semibold text-[#000000]">
                  Status
                </th>
                <th className="px-4 py-3 text-xs font-semibold text-[#000000] text-right">
                  Total
                </th>
              </tr>
            </thead>
            <tbody>
              {filteredOrders.map((o) => (
                ...
                >
                  <td className="px-4 py-3 text-sm font-bold text-[#000000] whitespace-nowrap">
                    {o.id}
                  </td>
                  <td className="px-4 py-3 text-sm font-semibold text-[#000000] whitespace-nowrap">
                    {o.customer}
                  </td>
                  ...
                  <td className="px-4 py-3 text-sm whitespace-nowrap">
                    {o.driver ? (
                      ...
                      <span className="italic font-medium text-[#F97316]">
                        Unassigned
                      </span>
                    )}
                  </td>
