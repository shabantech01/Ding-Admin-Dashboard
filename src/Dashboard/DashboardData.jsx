  ...
  return (
    <div className="flex flex-col gap-4 p-4 border border-[#EDEDED] rounded-xl">
      ...
      <div className="flex items-center gap-1 text-xs">
        ...
        <span
          className={`font-semibold ${isUp ? "text-[#16A34A]" : "text-[#EF4444]"}`}
        >
          {stat.change}
        </span>
              ...
              {topRestaurants.map((r) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div
                      className={`w-8 h-8 flex items-center justify-center rounded-full text-xs font-bold shrink-0 ${r.badgeBg} ${r.badgeText}`}
                    >
                      #{r.rank}
                    </div>
