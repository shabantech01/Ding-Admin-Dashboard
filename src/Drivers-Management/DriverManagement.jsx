        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="flex flex-col gap-6 sm:gap-8 px-4 sm:px-6 py-6 sm:py-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <button onClick={() => setShowAddDriver(true)} className="flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 rounded-lg bg-[#765AB8] text-white text-sm font-semibold hover:bg-[#654A9F] transition-colors cursor-pointer whitespace-nowrap">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:items-center">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-xs sm:text-sm text-[#8C8C8C] whitespace-nowrap">Vehicle:</span>
                                <select
                                    value={activeVehicle}
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-[#F9F9F9] border-b border-[#EDEDED]">
                                    <th className="px-4 py-3 text-[14px] font-bold text-[#000000]">Courier</th>
                                    <th className="px-4 py-3 text-[14px] font-bold text-[#000000]">Vehicle</th>
                                    <th className="px-4 py-3 text-[14px] font-bold text-[#000000]">Activity Status</th>
                                    <th className="px-4 py-3 text-[14px] font-bold text-[#000000]">Contact Email</th>
                                    <th className="px-4 py-3 text-[14px] font-bold text-[#000000]">Deliveries</th>
                                    <th className="px-4 py-3 text-[14px] font-bold text-[#000000]">Joined Date</th>
                                </tr>
                            </thead>
                            <tbody>
                                {filteredDrivers.map((d) => (
                                    <tr key={d.id} className="border-b border-[#EDEDED] last:border-0 hover:bg-[#F9F9F9]">
                                        <td className="px-4 py-3">
                                            <p className="text-sm font-semibold text-[#000000]">{d.name}</p>
                                        ...
                                        <td className="px-4 py-3 text-sm text-[#5C5C5C]">{d.email}</td>
                                        <td className="px-4 py-3 text-sm font-bold text-[#000000]">{d.deliveries}</td>
                                        <td className="px-4 py-3 text-sm text-[#8C8C8C]">{d.joined}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="flex flex-col gap-3 md:hidden">
                        {filteredDrivers.map((d) => (
                            <div key={d.id} className="flex flex-col gap-3 p-4 border border-[#EDEDED] rounded-lg">
                                ...
                                <div className="flex items-center justify-between text-xs text-[#8C8C8C] pt-2 border-t border-[#EDEDED]">
                                    <span>
                                        <span className="font-bold text-[#000000]">{d.deliveries}</span> deliveries
                                    </span>
